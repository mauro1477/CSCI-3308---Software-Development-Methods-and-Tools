...
flag = -1;
function begin_play(){
	var myTextField1 = document.getElementById("player1_id").value;
	var myTextField2 = document.getElementById("player2_id").value;
	if(flag == 1)
	{
	...
	{
		if(isEmpty(myTextField1) || isEmpty(myTextField2)){
		...
		else
		{
			...
			var new_player1 = document.getElementById("player1_id").value;
			var new_player2 = document.getElementById("player2_id").value;
			console.log(new_player1);

			var move_Player1New = " (X)";
			var move_Player2New = " (O)";
			var move_Player1 = new_player1.concat(move_Player1New);
			var move_Player2 = new_player2.concat(move_Player2New);

			document.getElementById("player1_id").value = move_Player1;
			document.getElementById("player2_id").value = move_Player2;

			var turn_x = "Turn for: X";
			var turn_o = "Turn for: O";
			document.getElementById("turn_info").innerHTML = turn_x.bold();
		}
	}
}
